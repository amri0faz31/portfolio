...
const topics = [
  { name: "summary", path: "/topics/algorithms" },
...
export default function Sidebar() {
  return (
    <aside
      className="w-80 h-screen text-white  p-6 px-4 bg-cover fixed top-0 left-0 "
    ...
    >
      <h2 className="text-4xl text-blue-100 font-bold  p-4 ml-4 mt-6 mb-20 font-press-start">
      ...
      <nav className="flex flex-col space-y-5 " >
        {topics.map((topic) => (
          ...
          className="w-full  hover:bg-white/50  transition px-6 py-2 rounded
           glow4 text-teal-500 text-2xl font-vt323 p-4 bg-black/5">
